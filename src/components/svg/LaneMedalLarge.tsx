...
export default class LaneMedalLarge extends React.Component<LaneMedalInterface, {}> {
    ...
    getMedalColor() {
        let boxwidth = this.windowParams.getlengthMedalFinishList() * 2
    ...
    getMedalSVG() {
        ...
        if (this.props.place === "1" || this.props.place === "2" || this.props.place === "3") {
            return (
                <div>
                    <Box width={boxwidth}
                        height={this.windowParams.getBoxheight() * 2}
                        display="flex"
