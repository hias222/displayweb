...
export default class LaneNumberFinish extends React.Component<LaneNumberFinishInterface, {}> {
    ...
    getSwimmerSVG() {
        ...
        if (this.props.place === null || this.props.place === '') {
            return <g id='layericon' transform="translate(45,15) rotate(0)">
    ...
    getPlaceSVG() {
        ...
        let viewBoxSize = "0 0 " + (2 * this.boxwidth) + "  " + this.windowParams.getBoxViewheight()
        let path_lane = "M 0 3 h " + this.boxwidth + " l -" + diagonal + "," + this.windowParams.getBoxheight() + " h -" + (this.boxwidth - diagonal) + " z"
        let path_place = "M " + this.boxwidth + " 3 h " + this.boxwidth + " l -" + diagonal + "," + this.windowParams.getBoxheight() + " h -" + this.boxwidth + " z"
